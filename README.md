...
- [x] Add the ability to transfer funds from my checking account to my savings account.
- [x] Add the ability to transfer funds from my savings account to my checking accounts.
- [x] Add the ability to have multiple users. There are many steps to take here, so take the time to plan out the changes needed. This includes changes to the interface as well as changes to how you store the data.

### Epic Mode

- [x] Add simple password protection to your user's accounts
